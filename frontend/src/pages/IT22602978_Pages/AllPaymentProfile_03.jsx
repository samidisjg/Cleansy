...
const AllPaymentProfiles_03 = () => {
    ...
    return (
        <div className='bg-gray-300 p-3 rounded-lg m-4 overflow-hidden'>
            <h1 className='font-black text-2xl'>Payment Profiles</h1>
            <div className='max-full px-3 mt-6 mx-auto overflow-x-auto'>
                <div className='flex gap-4'>
                    {paymentProfiles && paymentProfiles.length > 0 ? (
                        ...
                        <p className='m-5 justify-center py-60 px-96'>No payment profiles found</p>
                    )}
                </div>
            </div>
