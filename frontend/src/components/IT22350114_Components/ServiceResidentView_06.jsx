...
<div class="w-full max-w-sm bg-white border bg-opacity-25 border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:bg-opacity-100" >
    <a href="#">
        <img class="p-8 rounded-t-lg" src={service.imageUrls} alt={service.serviceName} />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{service.serviceName}</h5>
        </a>
  ...
  <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">5.0</span> 
        ...
        <p className="text-gray-600 mt-2 mb-3">{service.serviceDescription}</p>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="/book-service/${service._id}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Book now</a>
        </div>
    </div>
</div>
