...
const ResidentServiceView = ({ service }) => {
  ...
  const handleClick = (e) => {
    if (service.serviceAvailability === "Unavailable") {
...
<div style={{ display: 'flex', justifyContent: 'center' }}>
      <div className="relative w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-200 bg-opacity-5 border-opacity-75 hover:bg-opacity-100">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            {service.serviceAvailability === "Available" ? (
              ...
              <button disabled className="text-white bg-gray-500 cursor-not-allowed shadow-md font-medium rounded-lg text-sm px-5 py-2.5 text-center">Unavailable</button>
            )}
          </div>
        </div>
